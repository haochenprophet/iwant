...
void Csha::sha256_transf(sha256_ctx *ctx, const uint8 *message,uint64 block_nb)
{
    uint32 w[64];
    uint32 wv[8];
    uint32 t1, t2;
...
void Csha::sha512_transf(sha512_ctx *ctx, const uint8 *message,uint64 block_nb)
{
    uint64 w[80];
    uint64 wv[8];
    uint64 t1, t2;
...
void  Csha::sha224(const uint8 *message, uint64 len, uint8 *digest)
{
    sha224_ctx ctx;

    this->sha224_init(&ctx);
    this->sha224_update(&ctx, message, len);
    this->sha224_final(&ctx, digest);
}

void  Csha::sha224_init(sha224_ctx *ctx)
{
#ifndef UNROLL_LOOPS
    int i;
    for (i = 0; i < 8; i++) {
...
void  Csha::sha224_update(sha224_ctx *ctx, const uint8 *message, uint64 len)
{
    uint64 block_nb;
    ...
    this->sha256_transf(ctx, ctx->block, 1);
    this->sha256_transf(ctx, shifted_message, block_nb);
...
void  Csha::sha224_final(sha224_ctx *ctx, uint8 *digest)
{
    uint64 block_nb;
    uint64 pm_len;
    uint64 len_b;
    ...
    *(ctx->block + pm_len - 9) = (uint8) ((tot_len >> 61) & 0x07);
    ...
    this->sha256_transf(ctx, ctx->block, block_nb);
...
void  Csha::sha256(const uint8 *message, uint64 len, uint8 *digest)
{
    sha256_ctx ctx;

    this->sha256_init(&ctx);
    this->sha256_update(&ctx, message, len);
    this->sha256_final(&ctx, digest);
}

void  Csha::sha256_init(sha256_ctx *ctx)
{
#ifndef UNROLL_LOOPS
    int i;
    for (i = 0; i < 8; i++) {
...
void  Csha::sha256_update(sha256_ctx *ctx, const uint8 *message, uint64 len)
{
    uint64 block_nb;
    uint64 new_len, rem_len, tmp_len;
    const uint8 *shifted_message;
...
void  Csha::sha256_final(sha256_ctx *ctx, uint8 *digest)
{
    uint64 block_nb;
    uint64 pm_len;
    uint64 len_b;
...
void  Csha::sha384(const uint8 *message, uint64 len, uint8 *digest)
{
    sha384_ctx ctx;

    this->sha384_init(&ctx);
    this->sha384_update(&ctx, message, len);
    this->sha384_final(&ctx, digest);
}

void  Csha::sha384_init(sha384_ctx *ctx)
{
#ifndef UNROLL_LOOPS
    int i;
    for (i = 0; i < 8; i++) {
...
void  Csha::sha384_update(sha384_ctx *ctx, const uint8 *message, uint64 len)
{
    uint64 block_nb;
    uint64 new_len, rem_len, tmp_len;
    const uint8 *shifted_message;
    ...
    this->sha512_transf(ctx, ctx->block, 1);
    this->sha512_transf(ctx, shifted_message, block_nb);
...
void  Csha::sha384_final(sha384_ctx *ctx, uint8 *digest)
{
    uint64 block_nb;
    uint64 pm_len;
    uint64 len_b;
    ...
    *(ctx->block + pm_len - 9) = (uint8) ((tot_len >> 61) & 0x07);
    ...
    this->sha512_transf(ctx, ctx->block, block_nb);
...
void Csha::sha512(const uint8 *message, uint64 len, uint8 *digest)
{
    sha512_ctx ctx;

    this->sha512_init(&ctx);
    this->sha512_update(&ctx, message, len);
    this->sha512_final(&ctx, digest);
}

void Csha::sha512_init(sha512_ctx *ctx)
{
#ifndef UNROLL_LOOPS
    int i;
    for (i = 0; i < 8; i++) {
...
void Csha::sha512_update(sha512_ctx *ctx, const uint8 *message, uint64 len)
{
    uint64 block_nb;
    uint64 new_len, rem_len, tmp_len;
    const uint8 *shifted_message;
...
void Csha::sha512_final(sha512_ctx *ctx, uint8 *digest)
{
    uint64 block_nb;
    uint64 pm_len;
    uint64 len_b;
