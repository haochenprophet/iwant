...
namespace n_object {
	...
	public:
		...
		//system command
		int sys_cmd(wstring* cmd, int loop_count = 1);
		int sys_cmd(wchar_t * cmd, int loop_count = 1);
		...
		virtual int different(void* p = nullptr);//code diff,file diff ,time diff ,image diff ..
